...
const SOCIAL_LINKS = [
  ...
  {
    name: "TikTok",
    href: "https://tiktok.com/@swaydaymusic",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: "Spotify",
    href: "https://open.spotify.com/artist/swayday",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/@swayday",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/swaydaymusic/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
...
export function SocialsRow() {
  ...
  return (
    <section id="socials" className="py-28 px-6 bg-brand-dark relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-brand-red/5 blur-3xl rounded-full" />
      </div>
        ...
        >
          {SOCIAL_LINKS.map((link) => (
            ...
            >
              ...
              <span className="text-xs tracking-widest text-slate-500 group-hover:text-slate-300 uppercase font-body transition-colors duration-200">
                {link.name}
              </span>
            </a>
          ))}
